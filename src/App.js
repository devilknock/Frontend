  ...
  useEffect(() => {
    ...
    const fetchLast = async () => {
      try {
        ...
        if (!stopped && j && j.signal) setSignal(j);
      } catch {}
    };
    fetchLast();
              ...
              onClick={async () => {
                try {
                  await fetch("https://aka-g2l0.onrender.com/push-ohlc", {
                    ...
                    body: JSON.stringify([
                      { t: 1, open: 100, high: 105, low: 99, close: 102, volume: 1000 },
                      { t: 2, open: 102, high: 106, low: 101, close: 104, volume: 900 },
                      { t: 3, open: 104, high: 107, low: 103, close: 106, volume: 950 }
                    ])
                  });
                } catch (e) {}
              }}
